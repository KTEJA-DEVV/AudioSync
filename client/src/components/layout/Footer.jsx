...
const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/crowdbeat',
    icon: (props) => (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/crowdbeat',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'Discord',
    href: 'https://discord.gg/crowdbeat',
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
      ...
      <div className="container-app py-8 lg:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-gray-900">CrowdBeat</span>
            </Link>
            <p className="mt-3 text-sm text-gray-500">
              Create music together with the crowd.
            </p>
            {/* Social Links */}
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-400 text-center">
            © {currentYear} CrowdBeat. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
